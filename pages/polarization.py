"""
Analyze Fluorescence Polarization page.
"""
...
def fit_and_plot(tmpdir):
    """
    Process fit and plot data for polarization assay.
    ...
    """
    # Call the shared processing function for polarization
...
setup_page_header("Analyze Fluorescence Polarization", "polarization.md")
...
data_dict = tabs.data_tab_table_polarization(data_tab, data_dict)
