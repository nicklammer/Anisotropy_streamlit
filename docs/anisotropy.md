...
## Overview
This page fits and plots fluorescence anisotropy binding data. Upload your raw plate-reader values or fill in the tables, add sample info to the sample table, configure fit and plot options, then click **Fit and plot** to generate plots.

## Data Input
- Upload your plate reader `.xlsx` file or enter parallel and perpendicular data into the data tables.
